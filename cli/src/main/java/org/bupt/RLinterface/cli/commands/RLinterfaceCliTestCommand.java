 ...
 */
package org.bupt.RLinterface.cli.commands;
...
public class RLinterfaceCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(RLinterfaceCliTestCommand.class);
    protected final RLinterfaceCliCommands service;

    public RLinterfaceCliTestCommand(final RLinterfaceCliCommands service) {
